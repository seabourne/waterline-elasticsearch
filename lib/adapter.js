...
module.exports = (function() {
  ...
  var adapter = {
    ...
    // Query with Native response
    query: function(conn, coll, options, cb) {
      grabConnection(conn).query(coll, options, cb);
    },
    // Count
    ...
    // Native
    native: function(conn, coll, cb) {
      cb(null, grabConnection(conn).client)
    }
  };
